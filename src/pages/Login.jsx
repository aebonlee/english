...
function Login() {
  ...
  return (
    <>
      <SEOHead title="로그인 - English Pro" description="English Pro에 로그인하여 영어 학습을 시작하세요." />

      <div className="login-page">
        <div className="login-container">
          <div className="login-header">
            <h1 className="login-header__title">English Pro</h1>
            <p className="login-header__subtitle">영어 학습의 새로운 시작</p>
          </div>
