    ...
    <>
      ...
      <section className="page-header" data-aos="fade-up">
        <nav className="breadcrumb">
          ...
          <span> / </span>
          <span>{t('\uBA74\uC811 \uC601\uC5B4', 'Interview English')}</span>
        </nav>
      ...
      {/* Section 4: "Tell me about a time when..." */}
      <section className="lesson-section" data-aos="fade-up" data-aos-delay="400">
        <h2>{t('"Tell me about a time when..." (\uD589\uB3D9 \uAE30\uBC18 \uC9C8\uBB38)', '"Tell me about a time when..." (Behavioral Questions)')}</h2>
        <p>
          {t(
      ...
      <section className="lesson-section" data-aos="fade-up" data-aos-delay="700">
      ...
      {/* Practice Section */}
      <section className="practice-section" data-aos="fade-up" data-aos-delay="800">
