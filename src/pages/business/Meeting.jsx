    ...
    <>
      ...
      <section className="page-header" data-aos="fade-up">
        <nav className="breadcrumb">
          ...
          <span> / </span>
          <span>{t('\uD68C\uC758 \uC601\uC5B4', 'Meeting English')}</span>
        </nav>
      ...
      {/* Section 3: Agreeing & Disagreeing */}
        ...
        <div className="example-box">
          ...
          <ul className="expression-list">
            ...
            <li>
              ...
              <span className="translation">{t(' - [이름]\uB2D8, \uC774 \uAC74\uC744 \uB2F4\uB2F9\uD574 \uC8FC\uC2DC\uACA0\uC2B5\uB2C8\uAE4C?', ' - [Name], could you handle this?')}</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span className="translation">{t(' - [날짜]\uAE4C\uC9C0 \uC644\uB8CC\uD574\uC57C \uD569\uB2C8\uB2E4.', ' - This needs to be done by [date].')}</span>
            </li>
            <li>
      ...
      {/* Useful Meeting Phrases Summary */}
