  ...
  return (
    <>
      ...
      <section className="lesson-section" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="example-box" data-aos="fade-up" data-aos-delay="150">
      ...
      {/* Section 6: Practice */}
      <section className="practice-section" data-aos="fade-up" data-aos-delay="600">
        ...
        <div className="example-box">
          ...
          <ul>
            <li>{t('\uACF5\uB3D9 \uB9C8\uCF00\uD305 \uCE60\uD398\uC778 \uB17C\uC758\uB97C \uC704\uD55C \uD68C\uC758 \uC694\uCCAD', 'Request a meeting to discuss a joint marketing campaign')}</li>
