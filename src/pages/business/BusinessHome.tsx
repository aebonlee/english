...
function BusinessHome(): React.ReactElement {
  const { t } = useLanguage();
  useAOS();
        ...
        <div className="container">
          <div className="lesson-body">
            ...
            <div className="callout-box">
              ...
              <ul>
                <li>{t('\uBE44\uC988\uB2C8\uC2A4 \uC774\uBA54\uC77C \uC791\uC131 \uBC0F \uD15C\uD50C\uB9BF \uD65C\uC6A9', 'Writing business emails and using templates')}</li>
                <li>{t('\uC601\uC5B4 \uD504\uB808\uC820\uD14C\uC774\uC158 \uBC0F \uD68C\uC758 \uC9C4\uD589', 'Delivering presentations and leading meetings in English')}</li>
                <li>{t('\uD611\uC0C1, \uC124\uB4DD, \uBA74\uC811 \uC0C1\uD669\uC5D0\uC11C\uC758 \uC804\uB7B5\uC801 \uC601\uC5B4 \uD45C\uD604', 'Strategic English expressions for negotiation, persuasion, and interviews')}</li>
              </ul>
            </div>

            <h2>{t('\uD559\uC2B5 \uC8FC\uC81C', 'Study Topics')}</h2>
