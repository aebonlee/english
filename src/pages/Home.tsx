...
function Home(): React.ReactElement {
  ...
  const scrollToCurriculum = (e: React.MouseEvent<HTMLAnchorElement>): void => {
    e.preventDefault();
  ...
  return (
    <>
      <SEOHead
        title={t('English Pro - 실용 영어 학습', 'English Pro - Practical English Learning')}
        description={t(
      ...
      <section className="hero" data-aos="fade-up">
        <div className="hero__content">
          <h1 className="hero__title">
            {t('실용 영어 마스터', 'Master Practical English')}
          </h1>
          ...
          {CURRICULUM_CARDS.map((card, index) => (
            ...
            >
              ...
              <h3 className="curriculum-card__title">
                {language === 'ko' ? card.title : card.titleEn}
              </h3>
      ...
      <section className="features-section" data-aos="fade-up">
        <div className="features-section__header">
          <h2 className="features-section__title">
            {t('Why English Pro?', 'Why English Pro?')}
          </h2>
