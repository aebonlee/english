...
export default function VocabBasic(): React.ReactElement {
  const { t } = useLanguage();
  useAOS();
    ...
    <>
      ...
      <div className="vocab-grid">
        {visibleWords.map((word) => (
          <div
            key={word.id}
            className={`vocab-card ${flipped[word.id] ? 'flipped' : ''} ${
              learned[word.id] ? 'learned' : ''
            }`}
            ...
            <div className="vocab-card-inner">
              <div className="vocab-card-front">
                <div className="card-top-row">
                  ...
                  <button
                    className={`learn-check ${learned[word.id] ? 'checked' : ''}`}
                    onClick={(e) => toggleLearned(e, word.id)}
                    title={learned[word.id] ? '학습 완료 취소' : '학습 완료'}
                  >
                    {learned[word.id] ? '✓' : '○'}
                  </button>
                </div>
