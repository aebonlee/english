...
const ACCENT_BG = '#f0faf4';
const ACCENT_BORDER = '#a9dfbf';

export default function VocabDaily(): React.ReactElement {
  const { t } = useLanguage();
  useAOS();
  ...
  return (
    <>
      <SEOHead
        title={t('일상 필수 단어 500 - English Pro', 'Daily Essential 500 - English Pro')}
        description={t(
          '일상생활에서 자주 사용되는 필수 어휘 500개를 학습하세요.',
          'Study 500 essential daily vocabulary words for everyday life.'
        )}
      />
      ...
      <section className="page-header" data-aos="fade-up">
        <div className="container">
          <div className="page-header__breadcrumb">
            ...
            <i className="fas fa-chevron-right"></i>
            <span>{t('일상 필수 단어', 'Daily Essential')}</span>
          </div>
          <h1 className="page-header__title">
            {t('일상 필수 단어 500', 'Daily Essential 500')}
          </h1>
          ...
          <div className="vocab-progress">
            <div className="vocab-progress-bar">
              <div
                ...
                style={{ width: `${(learnedCount / TOTAL_LABEL) * 100}%`, background: `linear-gradient(90deg, ${ACCENT_COLOR}, #1E8449)` }}
              />
            </div>
