...
const VALID_THEMES: string[] = ['auto', 'light', 'dark'];
const VALID_COLORS: string[] = ['blue', 'red', 'green', 'purple', 'orange'];
...
export function ThemeProvider({ children }: ThemeProviderProps): React.ReactElement {
  ...
  const [resolvedTheme, setResolvedTheme] = useState<string>(() => resolveTheme(getStoredTheme()));
  const [colorTheme, setColorThemeState] = useState<string>(getStoredColor);
