...
interface LevelLabelEntry {
  ko: string;
  en: string;
  color: string;
}

export interface LevelLabelsMap {
  [key: string]: LevelLabelEntry;
}
...
export const poetryWorks: LiteratureWork[] = [
  {
    id: 'frost-road',
...
export const proseWorks: LiteratureWork[] = [
  {
    id: 'aesop-tortoise',
...
export const levelLabels: LevelLabelsMap = {
